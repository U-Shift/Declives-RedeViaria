...
### Exercício
1. Experimenta fazer o mesmo exercício, gravando o output do `slope_raster` na variável `slopeSRTM` (para não fazer overwrite do `slope`), e **compara os resultados**.
Podes usar o `raster/LisboaSRTM_clip.tif`
2. Compara os resultados com os declives calculados com um raster de 10m.
Shapefile disponível em `shapefiles/RedeViariaLisboa_declives.gpkg`
