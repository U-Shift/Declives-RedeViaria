...
DATA = slopes::lisbon_road_network
DATA$slope_directed = slope_raster(DATA, dem = dem_lisbon_raster, directed = TRUE) # negative is downhill
DATA$slope = 100*abs(DATA$slope_directed)
...
DATA$direction[DATA$slope_directed < 0] = "TF" #To-From
...
curve(
  expr = speedfactor(slope = x, g = 7, length = 120),
  from = -35, to = 30, col = "blue", lwd = 1, log = "y",
  xlab = "slope [%]", ylab = "slope factor")
curve(
  expr = speedfactor(slope = x, g = 4, length = 120),
  from = 10, to = 30, col = "purple", lwd = 1, lty = 5, log = "y", add = T)
curve(
  expr = speedfactor(slope = x, g = 4.5, length = 120),
  from = 8, to = 30, col = "grey", lwd = 1, lty = 4, log = "y", add = T)
curve(
  expr = speedfactor(slope = x, g = 5, length = 120),
  from = 5, to = 30, col = "orange", lwd = 1, lty = 3, log = "y", add = T)
curve(
  expr = speedfactor(slope = x, g = 6, length = 120),
  from = 3, to = 30, col = "red", lwd = 1, lty = 2, log = "y", add = T)
curve(
  expr = speedfactor(slope = x, g = 7, length = 120),
  from = -35, to = 30, col = "blue", lwd = 1, log = "y", add = T)
abline(h = 1, v = 0, lty = 3)
points(slope, spf, log="y", add = T) #from the results
```
